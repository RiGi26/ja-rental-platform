...
import { ETicketPDF } from '@/components/ticket/ETicketPDF'
...
export async function GET(
  ...
  try {
    ...
    const element = React.createElement(ETicketPDF, {
      booking: {
    ...
    return new Response(new Uint8Array(buffer), {
      headers: {
        ...
        'Content-Disposition': `attachment; filename="eticket-${bookingCode}.pdf"`,
        'Cache-Control':       'no-store',
      },
    })
  } catch (err) {
    console.error('[ticket/pdf]', err)
    return new Response('Gagal generate PDF', { status: 500 })
  }
}
